...
<body style="background-color:white" onload="totalprice()" >
  ...
  <header id="header"><!--header-->
          ...
          <div class="col-sm-6">
            <div class="contactinfo">
              <ul class="nav nav-pills">
                <li><a href="#"><i class="fa fa-phone"></i> 076 8 336 333 (Monday - Friday 10.00 - 17.00 Hours)</a></li>
                <li><a href="#"><i class="fa fa-envelope"></i> info@grocerypal.lk</a></li>
              </ul>
            </div>
          </div>
          <div class="col-sm-6">
            <div class="social-icons pull-right">
              <ul class="nav navbar-nav">
                <li><a href="https://www.facebook.com/grocerypal.lk/"><i class="fa fa-facebook"></i></a></li>
        ...
        <div class="row">
          <div class="col-md-4 clearfix">
            <div class="logo pull-left">
              <a href="<?php echo web_root?>"><img src="images/home/logo123.png" alt="" /></a>
            </div> 
          </div>
          ...
          <div class="col-sm-4">
            <div class="single-widget">
              ...
              <ul class="nav nav-pills nav-stacked">
                <li>Lfinity Pvt Ltd, No 125, Maya avenue, Colombo 06, Sri Lanka</li><br>
                <li>Phone:076 8 336 333 (Monday - Friday 10.00 - 17.00 Hours)</li><br>
                <li>Email:info@grocerypal.lk</li><br>
                <li>Working:8.30 - 18.00 Hours, everyday</li>
              </ul>
            </div>
          </div>
          <div class="col-sm-4">
    ...
    <div class="footer-bottom">
      <div class="container">
        <div class="row">
          <p class="pull-center">Copyright © 2016 Lfinity (Pvt) Ltd. All Rights Reserved.</p>
        </div>
      </div>
    </div>
...
<script src="https://account.snatchbot.me/script.js"></script><script>window.sntchChat.Init(112126)</script>
</body>
</html>